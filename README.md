...
5-Fold CV test set 평균 (201 WSIs, Wild 113 / Mutant 88)

| Encoder | Model | AUC | F1 | Acc | Sens | Spec |
|---------|-------|----:|---:|----:|-----:|-----:|
| UNI2-H | ABMIL | **0.9699** | **0.9312** | **0.9404** | 0.9209 | 0.9557 |
| H-Optimus-0 | TransMIL | 0.9575 | 0.8926 | 0.9106 | 0.8536 | **0.9549** |
